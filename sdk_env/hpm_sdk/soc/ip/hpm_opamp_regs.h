 ...
 *
 */
#define OPAMP_CFG_CFG0_CSEL_MASK (0xF000000UL)
#define OPAMP_CFG_CFG0_CSEL_SHIFT (24U)
#define OPAMP_CFG_CFG0_CSEL_SET(x) (((uint32_t)(x) << OPAMP_CFG_CFG0_CSEL_SHIFT) & OPAMP_CFG_CFG0_CSEL_MASK)
#define OPAMP_CFG_CFG0_CSEL_GET(x) (((uint32_t)(x) & OPAMP_CFG_CFG0_CSEL_MASK) >> OPAMP_CFG_CFG0_CSEL_SHIFT)

/*
 * VSWITCH_SEL (RW)
 *
 */
#define OPAMP_CFG_CFG0_VSWITCH_SEL_MASK (0x70000UL)
#define OPAMP_CFG_CFG0_VSWITCH_SEL_SHIFT (16U)
#define OPAMP_CFG_CFG0_VSWITCH_SEL_SET(x) (((uint32_t)(x) << OPAMP_CFG_CFG0_VSWITCH_SEL_SHIFT) & OPAMP_CFG_CFG0_VSWITCH_SEL_MASK)
#define OPAMP_CFG_CFG0_VSWITCH_SEL_GET(x) (((uint32_t)(x) & OPAMP_CFG_CFG0_VSWITCH_SEL_MASK) >> OPAMP_CFG_CFG0_VSWITCH_SEL_SHIFT)
 ...
 *
 */
#define OPAMP_CFG_CFG1_OPAOUT_SEL_MASK (0x3000000UL)
#define OPAMP_CFG_CFG1_OPAOUT_SEL_SHIFT (24U)
#define OPAMP_CFG_CFG1_OPAOUT_SEL_SET(x) (((uint32_t)(x) << OPAMP_CFG_CFG1_OPAOUT_SEL_SHIFT) & OPAMP_CFG_CFG1_OPAOUT_SEL_MASK)
#define OPAMP_CFG_CFG1_OPAOUT_SEL_GET(x) (((uint32_t)(x) & OPAMP_CFG_CFG1_OPAOUT_SEL_MASK) >> OPAMP_CFG_CFG1_OPAOUT_SEL_SHIFT)

/*
 * ISEL (RW)
 *
 */
#define OPAMP_CFG_CFG1_ISEL_MASK (0x30000UL)
#define OPAMP_CFG_CFG1_ISEL_SHIFT (16U)
#define OPAMP_CFG_CFG1_ISEL_SET(x) (((uint32_t)(x) << OPAMP_CFG_CFG1_ISEL_SHIFT) & OPAMP_CFG_CFG1_ISEL_MASK)
#define OPAMP_CFG_CFG1_ISEL_GET(x) (((uint32_t)(x) & OPAMP_CFG_CFG1_ISEL_MASK) >> OPAMP_CFG_CFG1_ISEL_SHIFT)

/*
 * PGA_SEL (RW)
 *
 */
#define OPAMP_CFG_CFG1_PGA_SEL_MASK (0xFFU)
#define OPAMP_CFG_CFG1_PGA_SEL_SHIFT (0U)
#define OPAMP_CFG_CFG1_PGA_SEL_SET(x) (((uint32_t)(x) << OPAMP_CFG_CFG1_PGA_SEL_SHIFT) & OPAMP_CFG_CFG1_PGA_SEL_MASK)
#define OPAMP_CFG_CFG1_PGA_SEL_GET(x) (((uint32_t)(x) & OPAMP_CFG_CFG1_PGA_SEL_MASK) >> OPAMP_CFG_CFG1_PGA_SEL_SHIFT)
