...
typedef struct {
    __RW uint32_t RESOURCE[311];               /* 0x0 - 0x4D8: Resource control register for cpu0_core */
    __R  uint8_t  RESERVED0[804];              /* 0x4DC - 0x7FF: Reserved */
    struct {
    ...
    struct {
        ...
        __RW uint32_t RET_WAIT;                /* 0x1010: Power Setting */
    } POWER[1];
    __R  uint8_t  RESERVED4[1004];             /* 0x1014 - 0x13FF: Reserved */
    struct {
    ...
    __RW uint32_t CLOCK[36];                   /* 0x1804 - 0x1890: Clock setting */
    __R  uint8_t  RESERVED6[876];              /* 0x1894 - 0x1BFF: Reserved */
    __RW uint32_t ADCCLK[2];                   /* 0x1C00 - 0x1C04: Clock setting */
    __RW uint32_t DACCLK[2];                   /* 0x1C08 - 0x1C0C: Clock setting */
    __R  uint8_t  RESERVED7[1008];             /* 0x1C10 - 0x1FFF: Reserved */
...
/* Bitfield definition for register of struct array POWER: RET_WAIT */
/*
 * WAIT (RW)
 *
 ...
 * clock cycles count on 24MHz
 */
#define SYSCTL_POWER_RET_WAIT_WAIT_MASK (0xFFFFFUL)
#define SYSCTL_POWER_RET_WAIT_WAIT_SHIFT (0U)
#define SYSCTL_POWER_RET_WAIT_WAIT_SET(x) (((uint32_t)(x) << SYSCTL_POWER_RET_WAIT_WAIT_SHIFT) & SYSCTL_POWER_RET_WAIT_WAIT_MASK)
#define SYSCTL_POWER_RET_WAIT_WAIT_GET(x) (((uint32_t)(x) & SYSCTL_POWER_RET_WAIT_WAIT_MASK) >> SYSCTL_POWER_RET_WAIT_WAIT_SHIFT)
...
#define SYSCTL_CLOCK_CLK_TOP_CAN0 (1UL)
...
#define SYSCTL_CLOCK_CLK_TOP_I2C0 (13UL)
#define SYSCTL_CLOCK_CLK_TOP_I2C1 (14UL)
#define SYSCTL_CLOCK_CLK_TOP_I2C2 (15UL)
#define SYSCTL_CLOCK_CLK_TOP_I2C3 (16UL)
#define SYSCTL_CLOCK_CLK_TOP_SPI0 (17UL)
#define SYSCTL_CLOCK_CLK_TOP_SPI1 (18UL)
#define SYSCTL_CLOCK_CLK_TOP_SPI2 (19UL)
#define SYSCTL_CLOCK_CLK_TOP_SPI3 (20UL)
#define SYSCTL_CLOCK_CLK_TOP_URT0 (21UL)
#define SYSCTL_CLOCK_CLK_TOP_URT1 (22UL)
#define SYSCTL_CLOCK_CLK_TOP_URT2 (23UL)
#define SYSCTL_CLOCK_CLK_TOP_URT3 (24UL)
#define SYSCTL_CLOCK_CLK_TOP_URT4 (25UL)
#define SYSCTL_CLOCK_CLK_TOP_URT5 (26UL)
#define SYSCTL_CLOCK_CLK_TOP_URT6 (27UL)
#define SYSCTL_CLOCK_CLK_TOP_URT7 (28UL)
#define SYSCTL_CLOCK_CLK_TOP_XPI0 (29UL)
#define SYSCTL_CLOCK_CLK_TOP_ANA0 (30UL)
#define SYSCTL_CLOCK_CLK_TOP_ANA1 (31UL)
#define SYSCTL_CLOCK_CLK_TOP_ANA2 (32UL)
#define SYSCTL_CLOCK_CLK_TOP_ANA3 (33UL)
#define SYSCTL_CLOCK_CLK_TOP_REF0 (34UL)
#define SYSCTL_CLOCK_CLK_TOP_REF1 (35UL)
...
#define SYSCTL_DACCLK_CLK_TOP_DAC1 (1UL)
