...
typedef enum {
    ...
    sysctl_resource_clk_top_can0 = 66,
    sysctl_resource_clk_top_can1 = 67,
    sysctl_resource_clk_top_can2 = 68,
    sysctl_resource_clk_top_can3 = 69,
    sysctl_resource_clk_top_lin0 = 70,
    sysctl_resource_clk_top_lin1 = 71,
    sysctl_resource_clk_top_lin2 = 72,
    sysctl_resource_clk_top_lin3 = 73,
    sysctl_resource_clk_top_gptmr0 = 74,
    sysctl_resource_clk_top_gptmr1 = 75,
    sysctl_resource_clk_top_gptmr2 = 76,
    sysctl_resource_clk_top_gptmr3 = 77,
    ...
    sysctl_resource_clk_top_adc1 = 102,
    sysctl_resource_clk_top_dac0 = 103,
    sysctl_resource_clk_top_dac1 = 104,
    ...
    sysctl_resource_can0 = 260,
    sysctl_resource_can1 = 261,
    sysctl_resource_can2 = 262,
    sysctl_resource_can3 = 263,
    sysctl_resource_ptpc = 264,
    sysctl_resource_lin0 = 265,
    sysctl_resource_lin1 = 266,
    sysctl_resource_lin2 = 267,
    sysctl_resource_lin3 = 268,
    sysctl_resource_gptmr0 = 269,
    sysctl_resource_gptmr1 = 270,
    sysctl_resource_gptmr2 = 271,
    sysctl_resource_gptmr3 = 272,
    ...
    sysctl_resource_adc1 = 295,
    sysctl_resource_dac0 = 296,
    sysctl_resource_dac1 = 297,
    sysctl_resource_acmp = 298,
    sysctl_resource_opa0 = 299,
    sysctl_resource_opa1 = 300,
    sysctl_resource_mot0 = 301,
    sysctl_resource_rng0 = 302,
    sysctl_resource_sdp0 = 303,
...
typedef enum {
    ...
    monitor_target_clk_top_can1 = 131,
    monitor_target_clk_top_can2 = 132,
    monitor_target_clk_top_can3 = 133,
    monitor_target_clk_top_lin0 = 134,
    monitor_target_clk_top_lin1 = 135,
    monitor_target_clk_top_lin2 = 136,
    monitor_target_clk_top_lin3 = 137,
    monitor_target_clk_top_gptmr0 = 138,
    monitor_target_clk_top_gptmr1 = 139,
    monitor_target_clk_top_gptmr2 = 140,
    monitor_target_clk_top_gptmr3 = 141,
    ...
    monitor_target_clk_top_uart5 = 155,
    monitor_target_clk_top_uart6 = 156,
    monitor_target_clk_top_uart7 = 157,
