...
int main(void)
{
    ...
    tranceiver_config.asynchronous_config.parity_enable = true;
    tranceiver_config.asynchronous_config.parity = sei_asynchronous_parity_even;
    ...
    tranceiver_config.asynchronous_config.baudrate = 9600;
    ...
    sei_set_data_value(HPM_SEI, SEI_DAT_2, 0x40);    /* addr */
    ...
    sei_set_data_value(HPM_SEI, SEI_DAT_3, 0x42);    /* cmd */
    /* data register 4: crc */
    ...
    /* [3] instructions */
    instr_idx = 0;
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, 0, SEI_DAT_4, SEI_DAT_2, 8);  /* Send addr */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, 0, SEI_DAT_4, SEI_DAT_3, 8);  /* Send cmd */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, 0, SEI_DAT_0, SEI_DAT_4, 8);  /* Send crc */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_HALT, 0, SEI_DAT_0, SEI_DAT_0, 5);  /* halt some cycles */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, 0, SEI_DAT_8, SEI_DAT_5, 1);  /* recv addr */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, 0, SEI_DAT_8, SEI_DAT_5, 7);  /* recv addr */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, 0, SEI_DAT_8, SEI_DAT_6, 8);  /* recv cmd */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, 0, SEI_DAT_8, SEI_DAT_7, 32); /* recv pos */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, 0, SEI_DAT_0, SEI_DAT_8, 8);  /* check crc */
...
void isr_sei(void)
{
    ...
    if (sei_get_irq_status(HPM_SEI, BOARD_SEI_CTRL, SEI_CTRL_IRQ_INT_FLAG_LATCH1_MASK)) {
        ...
        printf("POS:%#x, addr:%#x, sample_tm:%u, update_tm:%u, TimeDelay:%d us\n",
                sei_get_data_value(HPM_SEI, SEI_DAT_7), sei_get_data_value(HPM_SEI, SEI_DAT_5),
