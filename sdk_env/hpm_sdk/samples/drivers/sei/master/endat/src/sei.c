...
int main(void)
{
    ...
    sei_set_xcvr_tx_point(HPM_SEI, BOARD_SEI_CTRL, sei_get_xcvr_ck0_point(HPM_SEI, BOARD_SEI_CTRL));
    ...
    sei_set_command_value(HPM_SEI, BOARD_SEI_CTRL, 0x07);
    ...
    /* [3] sei instructions */
    instr_idx = 0;
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, SEI_INSTR_M_CK_FALL_RISE, SEI_DAT_0, SEI_DAT_0, 1);   /* recv: 1 bit */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, SEI_INSTR_M_CK_FALL_RISE, SEI_DAT_0, SEI_DAT_0, 1);   /* recv: 1 bit */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, SEI_INSTR_M_CK_FALL_RISE, SEI_DAT_0, SEI_DAT_1, 6);   /* send: mode cmd */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, SEI_INSTR_M_CK_FALL_RISE, SEI_DAT_0, SEI_DAT_0, 1);   /* recv: 1 bit */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, SEI_INSTR_M_CK_FALL_RISE, SEI_DAT_0, SEI_DAT_0, 1);   /* recv: 1 bit */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_WAIT, SEI_INSTR_M_CK_FALL_RISE, SEI_DAT_0, SEI_DAT_30, 1);  /* wait: 0 */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_WAIT, SEI_INSTR_M_CK_FALL_RISE, SEI_DAT_0, SEI_DAT_31, 1);  /* wait: 1 */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, SEI_INSTR_M_CK_FALL_RISE, SEI_DAT_4, SEI_DAT_2, 1);   /* error: 1 bit*/
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, SEI_INSTR_M_CK_FALL_RISE, SEI_DAT_4, SEI_DAT_3, 25);  /* recv: 25 bit ST*/
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, SEI_INSTR_M_CK_FALL_RISE, SEI_DAT_0, SEI_DAT_4, 5);   /* CRC */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_WAIT, SEI_INSTR_M_CK_HIGH, SEI_DAT_0, SEI_DAT_30, 0);       /* timeout */
    ...
    update_config.enable_rev = false;
    ...
    /* [10] trigger config */
    sei_set_trig_input_command_value(HPM_SEI, BOARD_SEI_CTRL, sei_trig_in_period, 0x07);
