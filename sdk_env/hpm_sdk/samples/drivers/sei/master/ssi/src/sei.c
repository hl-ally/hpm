...
int main(void)
{
    ...
    /* [3] sei instructions */
    instr_idx = 0;
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, SEI_INSTR_M_CK_FALL_RISE, SEI_DAT_0, SEI_DAT_0, 1);
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, SEI_INSTR_M_CK_FALL_RISE, SEI_DAT_0, SEI_DAT_31, 1);   /* 1 */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, SEI_INSTR_M_CK_FALL_RISE, SEI_DAT_0, SEI_DAT_2, 12);   /* MT */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_RECV, SEI_INSTR_M_CK_FALL_RISE, SEI_DAT_0, SEI_DAT_3, 12);   /* ST */
    ...
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_HALT, SEI_INSTR_M_CK_HIGH, SEI_DAT_0, SEI_DAT_0, 0);
