...
int main(void)
{
    ...
    /* [3] sei instructions */
    instr_idx = 0;
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, SEI_INSTR_S_CK_TIMEOUT_EN, SEI_DAT_0, SEI_DAT_31, 1);  /* 1 */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, SEI_INSTR_S_CK_TIMEOUT_EN, SEI_DAT_0, SEI_DAT_2, 12);  /* MT */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, SEI_INSTR_S_CK_TIMEOUT_EN, SEI_DAT_0, SEI_DAT_3, 12);  /* ST */
