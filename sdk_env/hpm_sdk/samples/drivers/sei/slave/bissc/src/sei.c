...
int main(void)
{
    ...
    sei_set_xcvr_rx_point(HPM_SEI, BOARD_SEI_CTRL, 2);
    ...
    /* [3] sei instructions */
    instr_idx = 0;
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, SEI_INSTR_S_CK_TIMEOUT_EN, SEI_DAT_0, SEI_DAT_31, 1);
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, SEI_INSTR_S_CK_TIMEOUT_EN, SEI_DAT_0, SEI_DAT_30, 1);  /* ACK:0 */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, SEI_INSTR_S_CK_TIMEOUT_EN, SEI_DAT_0, SEI_DAT_31, 1);  /* START:1 */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, SEI_INSTR_S_CK_TIMEOUT_EN, SEI_DAT_0, SEI_DAT_30, 1);  /* CDS */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, SEI_INSTR_S_CK_TIMEOUT_EN, SEI_DAT_5, SEI_DAT_2, 12);  /* MT */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, SEI_INSTR_S_CK_TIMEOUT_EN, SEI_DAT_5, SEI_DAT_3, 12);  /* ST */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, SEI_INSTR_S_CK_TIMEOUT_EN, SEI_DAT_5, SEI_DAT_4, 2);   /* Error Warn*/
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, SEI_INSTR_S_CK_TIMEOUT_EN, SEI_DAT_0, SEI_DAT_5, 6);   /* CRC */
    sei_set_instr(HPM_SEI, instr_idx++, SEI_INSTR_OP_SEND, SEI_INSTR_S_CK_TIMEOUT_EN, SEI_DAT_0, SEI_DAT_30, 10); /* timeout */
    ...
    sei_set_sample_rev_override_value(HPM_SEI, BOARD_SEI_CTRL, mock_rev);
...
void isr_sei(void)
{
    ...
    if (sei_get_irq_status(HPM_SEI, BOARD_SEI_CTRL, SEI_CTRL_IRQ_INT_FLAG_LATCH0_MASK)) {
        ...
        sei_set_sample_pos_override_value(HPM_SEI, BOARD_SEI_CTRL, mock_pos);
        sei_set_sample_rev_override_value(HPM_SEI, BOARD_SEI_CTRL, mock_rev);
        sei_set_data_value(HPM_SEI, SEI_DAT_4, 0x03);
